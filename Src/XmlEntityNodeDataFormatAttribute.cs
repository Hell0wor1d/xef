...
//FileName:        XmlEntityNodeDataFormatAttribute
...
namespace XmlEntityFramework
{
    ...
    public class XmlEntityNodeDataFormatAttribute :Attribute
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XmlEntityNodeDataFormatAttribute" /> class.
        /// </summary>
        /// <param name="dataFormat">The data format.</param>
        public XmlEntityNodeDataFormatAttribute(string dataFormat)
        {
